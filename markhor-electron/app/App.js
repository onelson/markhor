...
class App extends Component {
  ...
  componentDidMount() {
      this.props.store.dispatch(ActionCreators.fetchAllData());
      ...
      document.body.addEventListener('keydown', (event) => {
          ...
          if (tabKeys.includes(event.keyCode)) {
              ...
              if (state.selection.tab !== tabIndex) {
                  this.props.store.dispatch(ActionCreators.updateSelectedTab(tabIndex));
              }
          }
              ...
              if (state.selection.tab === ZONE_TAB) {
                  ...
                  if (nextZone !== undefined) {
                      this.props.store.dispatch(ActionCreators.updateSelectedZone(nextZone || null));
                  }
              }
          }
